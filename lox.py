...
class Lox:
    def __init__(self):
        ...
        self.interpreter = Interpreter(error_reporter=self.error_reporter, use_resolver=True)
    ...
    def run(self, source: str):
        ...
        if self.had_error:
            return
        resolver = Resolver(self.interpreter, error_reporter=self.error_reporter)
